...
def read_input_lines_parameters():
    ...
    with open("numerical_input.txt", "r") as fin:
        data_num_inp = fin.read()
    ...
    with open("diagnostic_diagrams_input.txt", "r") as fin:
        data_input_DD = fin.read()
    ...
    with open("plots_parameters_input.txt", "r") as fin:
        datainputplots = fin.read()
