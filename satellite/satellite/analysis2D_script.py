...
def analysis2D(flux2D, flux2D_error, flux_angles_norm, ang, line_names,
               ...
               param_requered, param_mod_name, param_model_values, DD_name,
               DD_avail, DDxmin, DDxmax, DDymin, DDymax, hdr,
               flux_spec_slit_norm, flux_spec_slit_norm_error):

    if not os.path.isdir('output_Diagnostic_Diagrams'): os.mkdir('output_Diagnostic_Diagrams')
    ...
    for j in range(0, sizey):
        for i in range(0, sizex):
            if (flux2D.Ha_6563[i, j] > 0.0 and flux2D.Hb_4861[i, j] > 0.0 and
                ...
                corHeIa_er = RC.getErrCorr(5876,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corHeIb = RC.getCorr(6678, 4861)
                corHeIb_er = RC.getErrCorr(6678,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)

                corHeIIa = RC.getCorr(4686, 4861)
                corHeIIa_er = RC.getErrCorr(4686,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corHeIIb = RC.getCorr(5412, 4861)
                corHeIIb_er = RC.getErrCorr(5412,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                ...
                corNIIa_er = RC.getErrCorr(5755,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corNIIb = RC.getCorr(6548, 4861)
                corNIIb_er = RC.getErrCorr(6548,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corNIIc = RC.getCorr(6584, 4861)
                corNIIc_er = RC.getErrCorr(6584,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)

                corOIa = RC.getCorr(5577, 4861)
                corOIa_er = RC.getErrCorr(5577,
                                          np.std(obs_fake.extinction.E_BV),
                                          4861)
                corOIb = RC.getCorr(6300, 4861)
                corOIb_er = RC.getErrCorr(6300,
                                          np.std(obs_fake.extinction.E_BV),
                                          4861)
                corOIc = RC.getCorr(6363, 4861)
                corOIc_er = RC.getErrCorr(6363,
                                          np.std(obs_fake.extinction.E_BV),
                                          4861)

                corOIIa = RC.getCorr(3727, 4861)
                corOIIa_er = RC.getErrCorr(3727,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corOIIb = RC.getCorr(3729, 4861)
                corOIIb_er = RC.getErrCorr(3729,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corOIIc = RC.getCorr(7320, 4861)
                corOIIc_er = RC.getErrCorr(7320,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corOIId = RC.getCorr(7330, 4861)
                corOIId_er = RC.getErrCorr(7330,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)

                corOIIIa = RC.getCorr(4363, 4861)
                corOIIIa_er = RC.getErrCorr(4363,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corOIIIb = RC.getCorr(4959, 4861)
                corOIIIb_er = RC.getErrCorr(4959,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corOIIIc = RC.getCorr(5007, 4861)
                corOIIIc_er = RC.getErrCorr(5007,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)

                corSIIa = RC.getCorr(6716, 4861)
                corSIIa_er = RC.getErrCorr(6716,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corSIIb = RC.getCorr(6731, 4861)
                corSIIb_er = RC.getErrCorr(6731,
                                           np.std(obs_fake.extinction.E_BV),
                                           4861)
                corSIIIa = RC.getCorr(6312, 4861)
                corSIIIa_er = RC.getErrCorr(6312,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corSIIIb = RC.getCorr(9069, 4861)
                corSIIIb_er = RC.getErrCorr(9069,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)

                corClIIIa = RC.getCorr(5517, 4861)
                corClIIIa_er = RC.getErrCorr(5517,
                                             np.std(obs_fake.extinction.E_BV),
                                             4861)
                corClIIIb = RC.getCorr(5538, 4861)
                corClIIIb_er = RC.getErrCorr(5538,
                                             np.std(obs_fake.extinction.E_BV),
                                             4861)

                corNeIIIa = RC.getCorr(3868, 4861)
                corNeIIIa_er = RC.getErrCorr(3868,
                                             np.std(obs_fake.extinction.E_BV),
                                             4861)
                corNeIIIb = RC.getCorr(3967, 4861)
                corNeIIIb_er = RC.getErrCorr(3967,
                                             np.std(obs_fake.extinction.E_BV),
                                             4861)
                ...
                corCII_er = RC.getErrCorr(6461,
                                          np.std(obs_fake.extinction.E_BV),
                                          4861)

                corArIII = RC.getCorr(7136, 4861)
                corArIII_er = RC.getErrCorr(7136,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corArIVa = RC.getCorr(4712, 4861)
                corArIVa_er = RC.getErrCorr(4712,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)
                corArIVb = RC.getCorr(4740, 4861)
                corArIVb_er = RC.getErrCorr(4740,
                                            np.std(obs_fake.extinction.E_BV),
                                            4861)

                print("i={:}, j={:}".format(i, j))
                print("obs.getIntens()['H1r_6563A']={:}".format(
                ...
                flux_norm_2D_error.Ha_6563[i, j] = flux_norm_2D.Ha_6563[
                    i, j] * np.sqrt(par1**2 + par2**2 + par3**2)
                flux_norm_2D_error.Hb_4861[i, j] = 0.0

                index_extra_error = line_names.index("HI_4340e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.Hg_4340[i, j] = float(
                        obs.getIntens()['H1r_4341A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['H1r_4341A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHg_er / corHg)
                    flux_norm_2D_error.Hg_4340[i, j] = flux_norm_2D.Hg_4340[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("HI_4101e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.Hd_4101[i, j] = float(
                        obs.getIntens()['H1r_4102A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['H1r_4102A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHd_er / corHd)
                    flux_norm_2D_error.Hd_4101[i, j] = flux_norm_2D.Hd_4101[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("HeII_4686e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.HeIIa_4686[i, j] = float(
                        obs.getIntens()['He2r_4686A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['He2r_4686A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHeIIa_er / corHeIIa)
                    flux_norm_2D_error.HeIIa_4686[
                        i,
                        j] = flux_norm_2D.HeIIa_4686[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("HeII_5412e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.HeIIb_5412[i, j] = float(
                        obs.getIntens()['He2r_5411A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['He2r_5411A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHeIIb_er / corHeIIb)
                    flux_norm_2D_error.HeIIb_5412[
                        i,
                        j] = flux_norm_2D.HeIIb_5412[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("HeI_5876e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.HeIa_5876[i, j] = float(
                        obs.getIntens()['He1r_5876A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['He1r_5876A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHeIa_er / corHeIa)
                    flux_norm_2D_error.HeIa_5876[i, j] = flux_norm_2D.HeIa_5876[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("HeI_6678e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.HeIb_6678[i, j] = float(
                        obs.getIntens()['He1r_6678A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['He1r_6678A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corHeIb_er / corHeIb)
                    flux_norm_2D_error.HeIb_6678[i, j] = flux_norm_2D.HeIb_6678[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("N2_5755e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NIIa_5755[i, j] = float(
                        obs.getIntens()['N2_5755A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['N2_5755A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNIIa_er / corNIIa)
                    flux_norm_2D_error.NIIa_5755[i, j] = flux_norm_2D.NIIa_5755[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("N2_6548e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NIIb_6548[i, j] = float(
                        obs.getIntens()['N2_6548A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['N2_6548A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNIIb_er / corNIIb)
                    flux_norm_2D_error.NIIb_6548[i, j] = flux_norm_2D.NIIb_6548[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("N2_6583e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NIIc_6584[i, j] = float(
                        obs.getIntens()['N2_6584A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['N2_6584A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNIIc_er / corNIIc)
                    flux_norm_2D_error.NIIc_6584[i, j] = flux_norm_2D.NIIc_6584[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("N1_5199e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NI_5199[i,
                                         j] = float(obs.getIntens()['N1_5200A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['N1_5200A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNI_er / corNI)
                    flux_norm_2D_error.NI_5199[i, j] = flux_norm_2D.NI_5199[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O3_4363e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIIa_4363[i, j] = float(
                        obs.getIntens()['O3_4363A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O3_4363A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIIa_er / corOIIIa)
                    flux_norm_2D_error.OIIIa_4363[
                        i,
                        j] = flux_norm_2D.OIIIa_4363[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("O3_4959e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIIb_4959[i, j] = float(
                        obs.getIntens()['O3_4959A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O3_4959A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIIb_er / corOIIIb)
                    flux_norm_2D_error.OIIIb_4959[
                        i,
                        j] = flux_norm_2D.OIIIb_4959[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("O3_5007e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIIc_5007[i, j] = float(
                        obs.getIntens()['O3_5007A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O3_5007A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIIc_er / corOIIIc)
                    flux_norm_2D_error.OIIIc_5007[
                        i,
                        j] = flux_norm_2D.OIIIc_5007[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("O2_3727e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIa_3727[i, j] = float(
                        obs.getIntens()['O2_3726A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O2_3726A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIa_er / corOIIa)
                    flux_norm_2D_error.OIIa_3727[i, j] = flux_norm_2D.OIIa_3727[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O2_3729e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIb_3729[i, j] = float(
                        obs.getIntens()['O2_3729A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O2_3729A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIb_er / corOIIb)
                    flux_norm_2D_error.OIIb_3729[i, j] = flux_norm_2D.OIIb_3729[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O2_7320e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIIc_7320[i, j] = float(
                        obs.getIntens()['O2_7319A+'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O2_7319A+'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIIc_er / corOIIc)
                    flux_norm_2D_error.OIIc_7320[i, j] = flux_norm_2D.OIIc_7320[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O2_7330e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIId_7330[i, j] = float(
                    ...
                    flux_norm_2D_error.OIId_7330[i, j] = flux_norm_2D.OIId_7330[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O1_5577e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIa_5577[i, j] = float(
                        obs.getIntens()['O1_5577A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O1_5577A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIa_er / corOIa)
                    flux_norm_2D_error.OIa_5577[i, j] = flux_norm_2D.OIa_5577[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O1_6300e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIb_6300[i, j] = float(
                        obs.getIntens()['O1_6300A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O1_6300A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIb_er / corOIb)
                    flux_norm_2D_error.OIb_6300[i, j] = flux_norm_2D.OIb_6300[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("O1_6363e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.OIc_6363[i, j] = float(
                        obs.getIntens()['O1_6364A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['O1_6364A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corOIc_er / corOIc)
                    flux_norm_2D_error.OIc_6363[i, j] = flux_norm_2D.OIc_6363[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("S2_6716e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.SIIa_6716[i, j] = float(
                        obs.getIntens()['S2_6716A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['S2_6716A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corSIIa_er / corSIIa)
                    flux_norm_2D_error.SIIa_6716[i, j] = flux_norm_2D.SIIa_6716[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("S2_6731e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.SIIb_6731[i, j] = float(
                        obs.getIntens()['S2_6731A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['S2_6731A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corSIIb_er / corSIIb)
                    flux_norm_2D_error.SIIb_6731[i, j] = flux_norm_2D.SIIb_6731[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("S3_6312e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.SIIIa_6312[i, j] = float(
                        obs.getIntens()['S3_6312A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['S3_6312A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corSIIIa_er / corSIIIa)
                    flux_norm_2D_error.SIIIa_6312[
                        i,
                        j] = flux_norm_2D.SIIIa_6312[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("S3_9069e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.SIIIb_9069[i, j] = float(
                        obs.getIntens()['S3_9069A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['S3_9069A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corSIIIb_er / corSIIIb)
                    flux_norm_2D_error.SIIIb_9069[
                        i,
                        j] = flux_norm_2D.SIIIb_9069[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("Cl3_5517e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.ClIIIa_5517[i, j] = float(
                        obs.getIntens()['Cl3_5518A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Cl3_5518A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corClIIIa_er / corClIIIa)
                    flux_norm_2D_error.ClIIIa_5517[
                        i,
                        j] = flux_norm_2D.ClIIIa_5517[i, j] * np.sqrt(par1**2 +
                                                                      par2**2 +
                                                                      par3**2)

                index_extra_error = line_names.index("Cl3_5538e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.ClIIIb_5538[i, j] = float(
                        obs.getIntens()['Cl3_5538A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Cl3_5538A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corClIIIb_er / corClIIIb)
                    flux_norm_2D_error.ClIIIb_5538[
                        i,
                        j] = flux_norm_2D.ClIIIb_5538[i, j] * np.sqrt(par1**2 +
                                                                      par2**2 +
                                                                      par3**2)

                index_extra_error = line_names.index("Ar3_7136e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.ArIII_7136[i, j] = float(
                        obs.getIntens()['Ar3_7136A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Ar3_7136A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corArIII_er / corArIII)
                    flux_norm_2D_error.ArIII_7136[
                        i,
                        j] = flux_norm_2D.ArIII_7136[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("Ar4_4712e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.ArIVa_4712[i, j] = float(
                        obs.getIntens()['Ar4_4711A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Ar4_4711A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corArIVa_er / corArIVa)
                    flux_norm_2D_error.ArIVa_4712[
                        i,
                        j] = flux_norm_2D.ArIVa_4712[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("Ar4_4740e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.ArIVb_4740[i, j] = float(
                        obs.getIntens()['Ar4_4740A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Ar4_4740A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corArIVb_er / corArIVb)
                    flux_norm_2D_error.ArIVb_4740[
                        i,
                        j] = flux_norm_2D.ArIVb_4740[i, j] * np.sqrt(par1**2 +
                                                                     par2**2 +
                                                                     par3**2)

                index_extra_error = line_names.index("C1_8727e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.CI_8727[i,
                                         j] = float(obs.getIntens()['C1_8728A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['C1_8728A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corCI_er / corCI)
                    flux_norm_2D_error.CI_8727[i, j] = flux_norm_2D.CI_8727[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("C2_6461e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.CII_6461[i, j] = float(
                        obs.getIntens()['H1r_6563A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['H1r_6563A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corCII_er / corCII)
                    flux_norm_2D_error.CII_6461[i, j] = flux_norm_2D.CII_6461[
                        i, j] * np.sqrt(par1**2 + par2**2 + par3**2)

                index_extra_error = line_names.index("Ne3_3868e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NeIIIa_3868[i, j] = float(
                        obs.getIntens()['Ne3_3869A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Ne3_3869A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNeIIIa_er / corNeIIIa)
                    flux_norm_2D_error.NeIIIa_3868[
                        i,
                        j] = flux_norm_2D.NeIIIa_3868[i, j] * np.sqrt(par1**2 +
                                                                      par2**2 +
                                                                      par3**2)

                index_extra_error = line_names.index("Ne3_3967e")
                if lines_available[index_extra_error] == "yes":
                    flux_norm_2D.NeIIIb_3967[i, j] = float(
                        obs.getIntens()['Ne3_3968A'])
                    flux_norm_2D.Hb_4861[i, j] = float(
                        obs.getIntens()['H1r_4861A'])
                    par1 = float(obs.getError()['Ne3_3968A'])
                    par2 = float(obs.getError()['H1r_4861A'])
                    par3 = float(corNeIIIb_er / corNeIIIb)
                    flux_norm_2D_error.NeIIIb_3967[
                        i,
                        j] = flux_norm_2D.NeIIIb_3967[i, j] * np.sqrt(par1**2 +
                                                                      par2**2 +
                                                                      par3**2)
...
#########################################################################
    ...
    g2Dlrs.lineratios(flux_norm_2D, line_names, lines_available, lines_radial,
                      param_estimated, param_requered, param_mod_name,
                      param_model_values, hdr)
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                    > 2.84 * flux_angles_norm.Hb_4861[i]):
                ypar.append(-99)
                xpar.append(-99)
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = np.log10(flux_angles_norm.Ha_6563[i] /
                                        (flux_angles_norm.NIIb_6548[i] +
                                         flux_angles_norm.NIIc_6584[i]))
                xpar[number] = np.log10(flux_angles_norm.Ha_6563[i] /
                                        (flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]))
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.NIISIIplot(dataNII6548_6584,
                                            flux_norm_2D.Ha_6563,
                                            dataSII6716_6731,
                                            flux_norm_2D.Ha_6563, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        ...
        ax1.set_xlabel(r'log(H$\alpha$/[S II] (6716+6731))',
                       fontsize=21,
                       labelpad=16)
        ax1.set_ylabel(r'log(H$\alpha$/[N II] (6548+6584))',
                       fontsize=21,
                       labelpad=16)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = np.log10(flux_spec_slit_norm.Ha_6563[kk] /
                                  (flux_spec_slit_norm.NIIb_6548[kk] +
                                   flux_spec_slit_norm.NIIc_6584[kk]))
            spec_x[kk] = np.log10(flux_spec_slit_norm.Ha_6563[kk] /
                                  (flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]))
        ...
        if param_requered[index] == "yes":
            ...
            cbar = plt.colorbar(diag,
                                cmap=cm,
                                boundaries=bounds,
                                ticks=[0, 45, 90, 135, 180, 225, 270, 315, 360])

            ax2.scatter(np.mean(xpar),
                        np.mean(ypar),
                        s=300,
                        c="OrangeRed",
                        marker="x",
                        linewidths=4)  # average value from integrated spectrum
            ax2.scatter(spec_x,
                        spec_y,
                        s=100,
                        c="orange",
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.NIIc_6584[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.OIIINIIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                             dataNII6584, flux_norm_2D.Ha_6563,
                                             sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
            dataposy, number)
        ...
        if (DD_BPT_Kau == "no" and DD_BPT_Kew == "no"):
            ...
            ax3.plot(t3,
                     -2.19 * t3**6 - 15.61 * t3**5 - 44.8 * t3**4 -
                     66.3 * t3**3 - 54.1 * t3**2 - 24.23 * t3 - 4.23,
                     'g',
                     linewidth=3)  #similar to Sabin et al. 2010
            ax3.plot(t4, 0.945 * t4 / t4, 'g',
                     linewidth=3)  #similar to Sabin et al. 2010
            ax3.text(-1.5, 0.85, "H II", color='g', fontsize=21, rotation=0)

        if (DD_BPT_Kau == "yes"):
            ax3.plot(t1, (0.61 / (t1 - 0.05)) + 1.3,
                     label="Kauffmann03")  #Kauf03
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  (flux_spec_slit_norm.Hb_4861[kk]))
            spec_x[kk] = np.log10(flux_spec_slit_norm.NIIc_6584[kk] /
                                  (flux_spec_slit_norm.Ha_6563[kk]))
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10((flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]) /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
        ...
        dataposx, dataposy = dds.OIIISIIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                             dataSII6716_6731,
                                             flux_norm_2D.Ha_6563, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        ...
        if (DD_BPT_AGN == "no" and DD_BPT_LIN == "no"):
            ...
            ax3.plot(t3, -0.31 * t3 * t3 - 1.12 * t3 - 0.05, 'g',
                     linewidth=3)  #similar to Sabin et al. 2010
            ax3.plot(t4, 0.96 * t4 / t4, 'g',
                     linewidth=3)  #similar to Sabin et al. 2010
            ax3.text(-0.8, 0.3, "H II", color='g', fontsize=21, rotation=0)

        if (DD_BPT_AGN == "yes"):
            ax3.plot(t1, (0.72 / (t1 - 0.32)) + 1.3,
                     label="Kauffmann03")  #Kauf03
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  (flux_spec_slit_norm.Hb_4861[kk]))
            spec_x[kk] = np.log10((flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]) /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.HeIIa_4686[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIHeII4686plot(dataOIII5007,
                                                  flux_norm_2D.Hb_4861,
                                                  dataHeII4686,
                                                  flux_norm_2D.Hb_4861, sizex,
                                                  sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.HeIIa_4686[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.HeIIb_5412[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        #                         dds.NIISIIplot(y_numer,y_denom,x_numer,x_denom,sizex,sizey)
        dataposx, dataposy = dds.OIIIHeII5412plot(dataOIII5007,
                                                  flux_norm_2D.Hb_4861,
                                                  dataHeII5412,
                                                  flux_norm_2D.Hb_4861, sizex,
                                                  sizey)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.HeIIb_5412[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.NI_5199[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIINIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                            dataNI5199, flux_norm_2D.Hb_4861,
                                            sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.NI_5199[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.OIb_6300[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIOIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                            dataOI6300, flux_norm_2D.Ha_6563,
                                            sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.OIb_6300[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.NIIa_5755[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIINII5755plot(dataOIII5007,
                                                 flux_norm_2D.Hb_4861,
                                                 dataNII5755,
                                                 flux_norm_2D.Hb_4861, sizex,
                                                 sizey)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.NIIa_5755[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = flux_angles_norm.SIIa_6716[
                    i] / flux_angles_norm.SIIb_6731[i]
                xpar[number] = np.log10(flux_angles_norm.Ha_6563[i] /
                                        (flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]))
                number = number + 1
        ...
        dataposx, dataposy = dds.SII67166731HaSIIplot(dataSII6716, dataSII6731,
                                                      flux_norm_2D.Ha_6563,
                                                      dataSII, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = (flux_spec_slit_norm.SIIa_6716[kk] /
                          flux_spec_slit_norm.SIIb_6731[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.Ha_6563[kk] /
                                  (flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]))
    ...
    if DD_param == "yes":
        ...
        dataposx, dataposy = dds.SII67166731HaNIIplot(dataSII6716, dataSII6731,
                                                      flux_norm_2D.Ha_6563,
                                                      dataNII, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = flux_spec_slit_norm.SIIa_6716[
                kk] / flux_spec_slit_norm.SIIb_6731[kk]
            spec_x[kk] = np.log10(flux_spec_slit_norm.Ha_6563[kk] /
                                  (flux_spec_slit_norm.NIIb_6548[kk] +
                                   flux_spec_slit_norm.NIIc_6584[kk]))
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = np.log10((flux_angles_norm.NIIb_6548[i] +
                                         flux_angles_norm.NIIc_6584[i]) /
                                        (flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]))
                xpar[number] = np.log10((flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]) /
                                        (flux_angles_norm.OIb_6300[i]))
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.NIISIISIIOIplot(dataNII, dataSII, dataSII,
                                                 dataOI, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        plt.xlabel(r'log([N II] 6548+6584/[S II] 6716+6731)',
                   fontsize=21,
                   labelpad=16)
        plt.ylabel(r'log([S II] 6716+6731/[O I] 6300)',
                   fontsize=21,
                   labelpad=16)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = np.log10((flux_spec_slit_norm.NIIb_6548[kk] +
                                   flux_spec_slit_norm.NIIc_6584[kk]) /
                                  (flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]))
            spec_x[kk] = np.log10((flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]) /
                                  (flux_spec_slit_norm.OIb_6300[kk]))
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10((flux_angles_norm.NIIb_6548[i] +
                                        ...
                                        (flux_angles_norm.SIIa_6716[i] +
                                         flux_angles_norm.SIIb_6731[i]))
                xpar[number] = np.log10((flux_angles_norm.NIIb_6548[i] +
                                         flux_angles_norm.NIIc_6584[i]) /
                                        (flux_angles_norm.OIb_6300[i]))
                number = number + 1
            else:
        ...
        dataposx, dataposy = dds.NIISIINIIOIplot(dataNII, dataSII, dataNII,
                                                 dataOI, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        plt.xlabel(r'log([N II] 6548+6584/[S II] 6716+6731)',
                   fontsize=21,
                   labelpad=16)
        plt.ylabel(r'log([N II] 6548+6584/[O I] 6300)',
                   fontsize=21,
                   labelpad=16)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10((flux_spec_slit_norm.NIIb_6548[kk] +
                                  ...
                                  (flux_spec_slit_norm.SIIa_6716[kk] +
                                   flux_spec_slit_norm.SIIb_6731[kk]))
            spec_x[kk] = np.log10((flux_spec_slit_norm.NIIb_6548[kk] +
                                   flux_spec_slit_norm.NIIc_6584[kk]) /
                                  (flux_spec_slit_norm.OIb_6300[kk]))
    ...
    if DD_param == "yes":
        ...
        dataposx, dataposy = dds.OIIINII6584OIplot(dataOIII5007,
                                                   flux_norm_2D.Hb_4861,
                                                   dataNII6584, dataOI6300,
                                                   sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10((flux_angles_norm.OIIc_7320[i] +
                                         flux_angles_norm.OIId_7330[i]) /
                                        flux_angles_norm.OIIIc_5007[i])
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIOII732030OIIIplot(dataOIII5007,
                                                       flux_norm_2D.Hb_4861,
                                                       dataOII732030,
                                                       dataOIII5007, sizex,
                                                       sizey)
        ...
        plt.xlabel(r'log([O II] 7320+7330/[O III] 5007)',
                   fontsize=21,
                   labelpad=16)
        plt.ylabel(r'log([O III] 5007/H$\beta$)', fontsize=21, labelpad=16)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10((flux_spec_slit_norm.OIIc_7320[kk] +
                                   flux_spec_slit_norm.OIId_7330[kk]) /
                                  flux_spec_slit_norm.OIIIc_5007[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10((flux_angles_norm.OIIa_3727[i] +
                                         flux_angles_norm.OIIb_3729[i]) /
                                        flux_angles_norm.OIIIc_5007[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIOII372729OIIIplot(dataOIII5007,
                                                       flux_norm_2D.Hb_4861,
                                                       dataOII372729,
                                                       dataOIII5007, sizex,
                                                       sizey)
        ...
        plt.xlabel(r'log([O II] 3727+3729/[O III] 5007)',
                   fontsize=21,
                   labelpad=16)
        plt.ylabel(r'log([O III] 5007/H$\beta$)', fontsize=21, labelpad=16)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10((flux_spec_slit_norm.OIIa_3727[kk] +
                                   flux_spec_slit_norm.OIIb_3729[kk]) /
                                  flux_spec_slit_norm.OIIIc_5007[kk])
    ...
    if DD_param == "yes":
        ...
        dataposx, dataposy = dds.OIIIOII372729Hbplot(dataOIII5007,
                                                     flux_norm_2D.Hb_4861,
                                                     dataOII372729,
                                                     flux_norm_2D.Hb_4861,
                                                     sizex, sizey)
    ...
    if DD_param == "yes":
        ...
        dataposx, dataposy = dds.OIIIOII732030Haplot(dataOIII5007,
                                                     flux_norm_2D.Hb_4861,
                                                     dataOII732030,
                                                     flux_norm_2D.Ha_6563,
                                                     sizex, sizey)
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.HeIa_5876[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIHeIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                             dataHeI5876, flux_norm_2D.Ha_6563,
                                             sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.HeIa_5876[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.ArIII_7136[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIArIIIplot(dataOIII5007,
                                               flux_norm_2D.Hb_4861,
                                               dataArIII7136,
                                               flux_norm_2D.Ha_6563, sizex,
                                               sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.ArIII_7136[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.OIb_6300[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.OIb_6300[kk])
    ...
    if DD_param == "yes":
        ...
        dataposx, dataposy = dds.OIIININIIplot(dataOIII5007,
                                               flux_norm_2D.Hb_4861, dataNI5199,
                                               dataNII6584, sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
            dataposy, number)
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.NeIIIa_3868[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIINeIIIplot(dataOIII5007,
                                               flux_norm_2D.Hb_4861,
                                               dataNeIII3868,
                                               flux_norm_2D.Hb_4861, sizex,
                                               sizey)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.NeIIIa_3868[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.OIIIa_4363[i] /
                                        flux_angles_norm.Hg_4340[i])
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIOIIIHgplot(dataOIII5007,
                                                flux_norm_2D.Hb_4861,
                                                dataOIII4363,
                                                flux_norm_2D.Hg_4340, sizex,
                                                sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.OIIIa_4363[kk] /
                                  flux_spec_slit_norm.Hg_4340[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = flux_angles_norm.ArIVa_4712[
                    i] / flux_angles_norm.ArIVb_4740[i]
                number = number + 1
            else:
                ypar.append(-99)
                xpar.append(-99)
        ...
        dataposx, dataposy = dds.OIIIArIVplot(dataOIII5007,
                                              flux_norm_2D.Hb_4861,
                                              dataArIV4712, dataArIV4740, sizex,
                                              sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = flux_spec_slit_norm.ArIVa_4712[
                kk] / flux_spec_slit_norm.ArIVb_4740[kk]
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.CI_8727[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIICIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                            dataCI8727, flux_norm_2D.Ha_6563,
                                            sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.CI_8727[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ypar[number] = np.log10(flux_angles_norm.OIIIc_5007[i] /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.CII_6461[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
            else:
                ypar.append(-99)
        ...
        dataposx, dataposy = dds.OIIICIIplot(dataOIII5007, flux_norm_2D.Hb_4861,
                                             dataCII6461, flux_norm_2D.Ha_6563,
                                             sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        dataposy_mean, dataposy_std = ceos.estimates_without_outliers1D(
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            ...
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIIIc_5007[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.CII_6461[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = np.log10(flux_angles_norm.OIb_6300[i] /
                                        flux_angles_norm.Ha_6563[i])
                xpar[number] = np.log10(flux_angles_norm.CI_8727[i] /
                                        flux_angles_norm.Ha_6563[i])
                number = number + 1
        ...
        dataposx, dataposy = dds.OICIplot(dataOI6300, flux_norm_2D.Ha_6563,
                                          dataCI8727, flux_norm_2D.Ha_6563,
                                          sizex, sizey)
        dataposx_mean, dataposx_std = ceos.estimates_without_outliers1D(
            dataposx, number)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = np.log10(flux_spec_slit_norm.OIb_6300[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.CI_8727[kk] /
                                  flux_spec_slit_norm.Ha_6563[kk])
    ...
    if DD_param == "yes":
        ...
        for i in range(0, len(flux_angles_norm.Ha_6563)):
            if (flux_angles_norm.Ha_6563[i] > 0 and flux_angles_norm.Ha_6563[i]
                ...
                ang2.append(-99)
                ang2[number] = ang[i]
                ypar[number] = np.log10((flux_angles_norm.ArIVa_4712[i] +
                                         flux_angles_norm.ArIVb_4740[i]) /
                                        flux_angles_norm.Hb_4861[i])
                xpar[number] = np.log10(flux_angles_norm.HeIIa_4686[i] /
                                        flux_angles_norm.Hb_4861[i])
                number = number + 1
        ...
        dataposx, dataposy = dds.ArIVHeII4686plot(dataArIV471240,
                                                  flux_norm_2D.Hb_4861,
                                                  dataHeII4686,
                                                  flux_norm_2D.Hb_4861, sizex,
                                                  sizey)
        ...
        for kk in range(0, len(flux_spec_slit_norm.Ha_6563)):
            spec_x.append(-99)
            spec_y.append(-99)
            spec_y[kk] = np.log10((flux_spec_slit_norm.ArIVa_4712[kk] +
                                   flux_spec_slit_norm.ArIVb_4740[kk]) /
                                  flux_spec_slit_norm.Hb_4861[kk])
            spec_x[kk] = np.log10(flux_spec_slit_norm.HeIIa_4686[kk] /
                                  flux_spec_slit_norm.Hb_4861[kk])
