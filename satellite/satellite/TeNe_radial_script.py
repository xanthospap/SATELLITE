...
def TeNe(flux_angles, flux_angles_error, dist, line_names, lines_available,
    ...
    radial_length = [
        len(flux_angles.Ha_6563),
        len(flux_angles.Hb_4861),
        len(flux_angles.Hg_4340),
        len(flux_angles.Hd_4101),
        len(flux_angles.SIIa_6716),
        len(flux_angles.SIIb_6731),
        len(flux_angles.SIIIa_6312),
        len(flux_angles.SIIIb_9069),
        len(flux_angles.NIIa_5755),
        len(flux_angles.NIIb_6548),
        len(flux_angles.NIIc_6584),
        len(flux_angles.OIIIa_4363),
        len(flux_angles.OIIIb_4959),
        len(flux_angles.OIIIc_5007),
        len(flux_angles.OIIa_3727),
        len(flux_angles.OIIb_3729),
        len(flux_angles.OIIc_7320),
        len(flux_angles.OIId_7330),
        len(flux_angles.HeIa_5876),
        len(flux_angles.HeIb_6678),
        len(flux_angles.HeIIa_4686),
        len(flux_angles.HeIIb_5412),
        len(flux_angles.OIa_5577),
        len(flux_angles.OIb_6300),
        len(flux_angles.OIc_6363),
        len(flux_angles.NI_5199),
        len(flux_angles.ArIVa_4712),
        len(flux_angles.ArIVb_4740),
        len(flux_angles.ClIIIa_5517),
        len(flux_angles.ClIIIb_5538),
        len(flux_angles.NeIIIa_3868),
        len(flux_angles.NeIIIb_3967),
        len(flux_angles.ArIII_7136),
        len(flux_angles.CI_8727)
    ]
...
#        plt.show()
        ...
        print('{:03.2f}'.format(dist[i]),
              '{:06.0f}'.format(Te.NIISII[i]),
        ...
        print('{:03.2f}'.format(dist[i]),
              '{:06.0f}'.format(Te_error.NIISII[i]),
        ...
        ##########################
        ion_abun, ion_abun_error, atom_abun_fake = iars.ionicabundances(
            obs, obs_fake, Te, Te_error, Te_fake, Ne, Ne_error, Ne_fake, i,
            dist[i], line_names, lines_available, ion_abun, ion_abun_error,
            param_estimated, param_requered, param_mod_name)

        print('{:03.2f}'.format(dist[i]),
              '{:5.3e}'.format(ion_abun.HeIa[i]),
        ...
        print('{:03.2f}'.format(dist[i]),
              '{:5.3e}'.format(ion_abun_error.HeIa[i]),
        ...
        elem_abun_KB, elem_ICF_KB, elem_abun_DIMS, elem_ICF_DIMS, elem_abun_KB_error, elem_ICF_KB_error, elem_abun_DIMS_error, elem_ICF_DIMS_error, elem_abun_KB_ratio, elem_abun_KB_ratio_error, elem_abun_DIMS_ratio, elem_abun_DIMS_ratio_error = eaIrs.total_abundances_ICFs(
        ...
        print('{:03.0f}'.format(dist[i]),
              '{:5.2e}'.format(elem_abun_KB.He[i]),
              '{:5.2e}'.format(elem_abun_KB.N[i]),
              '{:09.0f}'.format(elem_ICF_KB.N[i]),
              '{:5.2e}'.format(elem_abun_DIMS.N[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.N[i]),
              '{:5.2e}'.format(elem_abun_KB.O[i]),
              '{:09.0f}'.format(elem_ICF_KB.O[i]),
              '{:5.2e}'.format(elem_abun_DIMS.O[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.O[i]),
              '{:5.2e}'.format(elem_abun_KB.S[i]),
              '{:09.0f}'.format(elem_ICF_KB.S[i]),
              '{:5.2e}'.format(elem_abun_DIMS.S[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.S[i]),
              '{:5.2e}'.format(elem_abun_KB.Ne[i]),
              '{:09.0f}'.format(elem_ICF_KB.Ne[i]),
              '{:5.2e}'.format(elem_abun_DIMS.Ne[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.Ne[i]),
              '{:5.2e}'.format(elem_abun_KB.Cl[i]),
              '{:09.0f}'.format(elem_ICF_KB.Cl[i]),
              '{:5.2e}'.format(elem_abun_DIMS.Cl[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.Cl[i]),
              '{:5.2e}'.format(elem_abun_KB.Ar[i]),
              '{:09.0f}'.format(elem_ICF_KB.Ar[i]),
              '{:5.2e}'.format(elem_abun_DIMS.Ar[i]),
              '{:09.0f}'.format(elem_ICF_DIMS.Ar[i]),
        ...
        print('{:03.0f}'.format(dist[i]),
              '{:5.2e}'.format(elem_abun_KB_error.He[i]),
    ...
    if param_requered[index_line1] == "yes" or param_requered[
            index_line2] == 'yes':

        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_Ne(SII6716_31)_both")
        ...
        plt.errorbar(dist2,
                     Te.NIISII,
                     yerr=Te_error.NIISII,
                     label="Te ([N II])")
        plt.errorbar(dist2,
                     Ne.NIISII,
                     yerr=Ne_error.NIISII,
                     label="Ne ([S II])")
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(SII6716_31)_both_radial.png")
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(SII6716_31)_both_radial.pdf")
#        plt.show()
...
# Te plot
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_only_Ne(SII6716_31)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(SII6716_31)_radial.png")
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(SII6716_31)_radial.pdf")
...
# Ne plot
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(SII6716_31)_only_Te(NII6548_84)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(NII6548_84)_radial.png")
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(NII6548_84)_radial.pdf")
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_Ne(SII6716_31)_both_radial.png")
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_Ne(SII6716_31)_both_radial.pdf")
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_only_Ne(SII6716_31)_radial.png")
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_only_Ne(SII6716_31)_radial.pdf")
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OI6300_63)_radial.png")
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OI6300_63)_radial.pdf")
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OII3727_29_7320_30)_Ne(SII6716_31)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.OIISII,
                     yerr=Te_error.OIISII,
                     label="Te ([O II])")
        plt.errorbar(dist2,
                     Ne.OIISII,
                     yerr=Ne_error.OIISII,
                     label="Ne ([S II])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_Ne(SII6716_31)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_Ne(SII6716_31)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OII3727_29_7320_30)_only_Ne(SII6716_31)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(SII6716_31)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(SII6716_31)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(SII6716_31)_only_Te(OII3727_29_7320_30)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OII3727_29_7320_30)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OII3727_29_7320_30)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_Ne(SII6716_31)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.OIIISII,
                     yerr=Te_error.OIIISII,
                     label="Te ([O III])")
        plt.errorbar(dist2,
                     Ne.OIIISII,
                     yerr=Ne_error.OIIISII,
                     label="Ne ([S II])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(SII6716_31)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(SII6716_31)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_only_Ne(SII6716_31)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(SII6716_31)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(SII6716_31)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(SII6716_31)_only_Te(OIII4959_5007)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OIII4959_5007)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(OIII4959_5007)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_Ne(SII6716_31)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.SIIISII,
                     yerr=Te_error.SIIISII,
                     label="Te ([S III])")
        plt.errorbar(dist2,
                     Ne.SIIISII,
                     yerr=Ne_error.SIIISII,
                     label="Ne ([S II])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(SII6716_31)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(SII6716_31)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_only_Ne(SII6716_31)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(SII6716_31)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(SII6716_31)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(SII6716_31)_only_Te(SIII6312_9069)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(SIII6312_9069)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(SII6716_31)_only_Te(SIII6312_9069)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OII3727_29_7320_30)_Ne(OII3727_29)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.OIIOII,
                     yerr=Te_error.OIIOII,
                     label="Te ([O II])")
        plt.errorbar(dist2,
                     Ne.OIIOII,
                     yerr=Ne_error.OIIOII,
                     label="Ne ([O II])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_Ne(OII3727_29)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_Ne(OII3727_29)_both_radial.pdf"
        )
#        plt.show()
...
# Te  plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OII3727_29_7320_30)_only_Ne(OII3727_29)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(OII3727_29)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OII3727_29_7320_30)_only_Ne(OII3727_29)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(OII3727_29)_only_Te(OII3727_29_7320_30)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(OII3727_29_7320_30)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(OII3727_29_7320_30)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_Ne(OII3727_29)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.NIIOII,
                     yerr=Te_error.NIIOII,
                     label="Te ([N II])")
        plt.errorbar(dist2,
                     Ne.NIIOII,
                     yerr=Ne_error.NIIOII,
                     label="Ne ([O II])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(OII3727_29)_both_radial.png")
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(OII3727_29)_both_radial.pdf")
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_only_Ne(OII3727_29)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(OII3727_29)_radial.png")
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(OII3727_29)_radial.pdf")
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(OII3727_29)_only_Te(NII6548_84)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(NII6548_84)_radial.png")
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(NII6548_84)_radial.pdf")
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_Ne(OII3727_29)_both_radial.png")
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_Ne(OII3727_29)_both_radial.pdf")
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_only_Ne(OII3727_29)_radial.png")
        fig.savefig(
            "output_radial_plots/Te(OI6300_63)_only_Ne(OII3727_29)_radial.pdf")
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(OI6300_63)_radial.png")
        fig.savefig(
            "output_radial_plots/Ne(OII3727_29)_only_Te(OI6300_63)_radial.pdf")
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_Ne(ClIII5517_38)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.OIIIClIII,
                     yerr=Te_error.OIIIClIII,
                     label="Te ([O III])")
        plt.errorbar(dist2,
                     Ne.OIIIClIII,
                     yerr=Ne_error.OIIIClIII,
                     label="Ne ([Cl III])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(ClIII5517_38)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(ClIII5517_38)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_only_Ne(ClIII5517_38)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(ClIII5517_38)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(ClIII5517_38)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(ClIII5517_38)_only_Te(OIII4959_5007)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(OIII4959_5007)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(OIII4959_5007)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_Ne(ClIII5517_38)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.SIIIClIII,
                     yerr=Te_error.SIIIClIII,
                     label="Te ([S III])")
        plt.errorbar(dist2,
                     Ne.SIIIClIII,
                     yerr=Ne_error.SIIIClIII,
                     label="Ne ([Cl III])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(ClIII5517_38)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(ClIII5517_38)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_only_Ne(ClIII5517_38)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(ClIII5517_38)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(ClIII5517_38)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(ClIII5517_38)_only_Te(SIII6312_9069)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(SIII6312_9069)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(SIII6312_9069)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_Ne(ArVI4712_40)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.OIIIArVI,
                     yerr=Te_error.OIIIArVI,
                     label="Te ([O III])")
        plt.errorbar(dist2,
                     Ne.OIIIArVI,
                     yerr=Ne_error.OIIIArVI,
                     label="Ne ([Ar VI])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(ArVI4712_40)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_Ne(ArVI4712_40)_both_radial.pdf"
        )
#        plt.show()
...
# Te  plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(OIII4959_5007)_only_Ne(ArVI4712_40)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(ArVI4712_40)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(OIII4959_5007)_only_Ne(ArVI4712_40)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(ArVI4712_40)_only_Te(OIII4959_5007)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(ArVI4712_40)_only_Te(OIII4959_5007)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(ArVI4712_40)_only_Te(OIII4959_5007)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_Ne(ArVI4712_40)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.SIIIArVI,
                     yerr=Te_error.SIIIArVI,
                     label="Te ([S III])")
        plt.errorbar(dist2,
                     Ne.SIIIArVI,
                     yerr=Ne_error.SIIIArVI,
                     label="Ne ([Ar VI])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(ArVI4712_40)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_Ne(ArVI4712_40)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(SIII6312_9069)_only_Ne(ArVI4712_40)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(ArVI4712_40)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(SIII6312_9069)_only_Ne(ArVI4712_40)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(ArVI4712_40)_only_Te(SIII6312_9069)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(ArVI4712_40)_only_Te(SIII6312_9069)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(ArVI4712_40)_only_Te(SIII6312_9069)_radial.pdf"
        )
...
# Te and Ne plot
    ...
    if param_requered[index_line1] == "yes" or param_requered[
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_Ne(ClIII5517_38)_both")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.errorbar(dist2,
                     Te.NIIClIII,
                     yerr=Te_error.NIIClIII,
                     label="Te ([N II])")
        plt.errorbar(dist2,
                     Ne.NIIClIII,
                     yerr=Ne_error.NIIClIII,
                     label="Ne ([Cl III])")
        plt.xlabel("Distance from CS (arcsec)", fontsize=21, labelpad=6)
        plt.ylabel(r'Te (K)/Ne (cm$^{-3}$)', fontsize=21, labelpad=6)
        ax1.tick_params(axis='x', labelsize=21, pad=6)
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(ClIII5517_38)_both_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_Ne(ClIII5517_38)_both_radial.pdf"
        )
#        plt.show()
...
# Te plot
    ...
    if param_requered[index_line1] == "yes":
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Te(NII6548_84)_only_Ne(ClIII5517_38)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(ClIII5517_38)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Te(NII6548_84)_only_Ne(ClIII5517_38)_radial.pdf"
        )
...
# Ne plot
    ...
    if param_requered[index_line2] == 'yes':
        ...
        # Read the necessary parameters (x or y axis) for the plots
        index_plotname = par_plotname.index(
            "Ne(ClIII5517_38)_only_Te(NII6548_84)")
        ymin = float(par_plotymin[index_plotname])
        ymax = float(par_plotymax[index_plotname])
        ...
        plt.ylim(ymin, ymax)
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(NII6548_84)_radial.png"
        )
        fig.savefig(
            "output_radial_plots/Ne(ClIII5517_38)_only_Te(NII6548_84)_radial.pdf"
        )
...
#############################################################################################
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.O,
                 yerr=elem_abun_KB_error.O,
                 label="O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.O,
                 yerr=elem_abun_DIMS_error.O,
                 label="O (DIMS)")
    index_line1 = line_names.index("O3_4363s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.OIIIa,
                     yerr=ion_abun_error.OIIIa,
                     label="O++ 4363")
    ...
    if lines_available[index_line1] == "yes" and lines_available[
        ...
        plt.errorbar(dist2,
                     ...
                     yerr=ion_abun_error.OIIIc,
                     label="O++ 5007")
    if lines_available[index_line1] == "no" and lines_available[
            index_line2] == "yes":
        plt.errorbar(dist2,
                     ion_abun.OIIIb,
                     yerr=ion_abun_error.OIIIb,
                     label="O++ 4959")
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.N,
                 yerr=elem_abun_KB_error.N,
                 label="N (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.N,
                 yerr=elem_abun_DIMS_error.N,
                 label="N (DIMS)")
    index_line1 = line_names.index("N1_5199s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.NI,
                     yerr=ion_abun_error.NI,
                     label="No 5199")
    index_line1 = line_names.index("N2_5755s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.NIIa,
                     yerr=ion_abun_error.NIIa,
                     label="N+ 5755")
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.S,
                 yerr=elem_abun_KB_error.S,
                 label="S (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.S,
                 yerr=elem_abun_DIMS_error.S,
                 label="S (DIMS)")
    index_line1 = line_names.index("S2_6716s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.SIIa,
                     yerr=ion_abun_error.SIIa,
                     label="S+ 6716")
    index_line1 = line_names.index("S2_6731s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.SIIb,
                     yerr=ion_abun_error.SIIb,
                     label="S+ 6731")
    index_line1 = line_names.index("S3_6312s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.SIIIa,
                     yerr=ion_abun_error.SIIIa,
                     label="S++ 6312")
    index_line1 = line_names.index("S3_9069s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.SIIIb,
                     yerr=ion_abun_error.SIIIb,
                     label="S++ 9069")
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.Ne,
                 yerr=elem_abun_KB_error.Ne,
                 label="Ne (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.Ne,
                 yerr=elem_abun_DIMS_error.Ne,
                 label="Ne (DIMS)")
    index_line1 = line_names.index("Ne3_3868s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.NeIIIa,
                     yerr=ion_abun_error.NeIIIa,
                     label="Ne++ 3868")
    index_line1 = line_names.index("Ne3_3967s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.NeIIIb,
                     yerr=ion_abun_error.NeIIIb,
                     label="Ne++ 3967")
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.Cl,
                 yerr=elem_abun_KB_error.Cl,
                 label="Cl (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.Cl,
                 yerr=elem_abun_DIMS_error.Cl,
                 label="Cl (DIMS)")
    index_line1 = line_names.index("Cl3_5517s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.ClIIIa,
                     yerr=ion_abun_error.ClIIIa,
                     label="Cl++ 5517")
    index_line1 = line_names.index("Cl3_5538s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.ClIIIb,
                     yerr=ion_abun_error.ClIIIb,
                     label="Cl++ 5538")
    ...
    plt.errorbar(dist2,
                 elem_abun_KB.Ar,
                 yerr=elem_abun_KB_error.Ar,
                 label="Ar (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS.Ar,
                 yerr=elem_abun_DIMS_error.Ar,
                 label="Ar (DIMS)")
    index_line1 = line_names.index("Ar3_7136s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.ArIII,
                     yerr=ion_abun_error.ArIII,
                     label="Ar++ 7136")
    index_line1 = line_names.index("Ar4_4712s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.ArIVa,
                     yerr=ion_abun_error.ArIVa,
                     label="Ar+++ 4712")
    index_line1 = line_names.index("Ar4_4740s")
    if lines_available[index_line1] == "yes":
        plt.errorbar(dist2,
                     ion_abun.ArIVb,
                     yerr=ion_abun_error.ArIVb,
                     label="Ar+++ 4740")
    ...
    fig, ax1 = plt.subplots(figsize=(12, 7))
    plt.errorbar(dist2,
                 elem_abun_KB_ratio.NO,
                 yerr=elem_abun_KB_ratio_error.NO,
                 label="N/O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS_ratio.NO,
                 yerr=elem_abun_DIMS_ratio_error.NO,
                 label="N/O (DIMS)")
    ...
    fig, ax1 = plt.subplots(figsize=(12, 7))
    plt.errorbar(dist2,
                 elem_abun_KB_ratio.SO,
                 yerr=elem_abun_KB_ratio_error.SO,
                 label="S/O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS_ratio.SO,
                 yerr=elem_abun_DIMS_ratio_error.SO,
                 label="S/O (DIMS)")
    ...
    fig, ax1 = plt.subplots(figsize=(12, 7))
    plt.errorbar(dist2,
                 elem_abun_KB_ratio.NeO,
                 yerr=elem_abun_KB_ratio_error.NeO,
                 label="Ne/O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS_ratio.NeO,
                 yerr=elem_abun_DIMS_ratio_error.NeO,
                 label="Ne/O (DIMS)")
    ...
    fig, ax1 = plt.subplots(figsize=(12, 7))
    plt.errorbar(dist2,
                 elem_abun_KB_ratio.ClO,
                 yerr=elem_abun_KB_ratio_error.ClO,
                 label="Cl/O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS_ratio.ClO,
                 yerr=elem_abun_DIMS_ratio_error.ClO,
                 label="Cl/O (DIMS)")
    ...
    fig, ax1 = plt.subplots(figsize=(12, 7))
    plt.errorbar(dist2,
                 elem_abun_KB_ratio.ArO,
                 yerr=elem_abun_KB_ratio_error.ArO,
                 label="Ar/O (KB)")
    plt.errorbar(dist2,
                 elem_abun_DIMS_ratio.ArO,
                 yerr=elem_abun_DIMS_ratio_error.ArO,
                 label="Ar/O (DIMS)")
    ...
    plt.errorbar(dist2,
                 elem_ICF_KB.N,
                 yerr=elem_ICF_KB_error.N,
                 label="N_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.N,
                 yerr=elem_ICF_DIMS_error.N,
                 label="N_ICF (DIMS)")
    ...
    plt.errorbar(dist2,
                 elem_ICF_KB.O,
                 yerr=elem_ICF_KB_error.O,
                 label="O_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.O,
                 yerr=elem_ICF_DIMS_error.O,
                 label="O_ICF (DIMS)")
    plt.errorbar(dist2,
                 elem_ICF_KB.S,
                 yerr=elem_ICF_KB_error.S,
                 label="S_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.S,
                 yerr=elem_ICF_DIMS_error.S,
                 label="S_ICF (DIMS)")
    ...
    plt.errorbar(dist2,
                 elem_ICF_KB.Cl,
                 yerr=elem_ICF_KB_error.Cl,
                 label="Cl_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.Cl,
                 yerr=elem_ICF_DIMS_error.Cl,
                 label="Cl_ICF (DIMS)")
    plt.errorbar(dist2,
                 elem_ICF_KB.Ne,
                 yerr=elem_ICF_KB_error.Ne,
                 label="Ne_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.Ne,
                 yerr=elem_ICF_DIMS_error.Ne,
                 label="Ne_ICF (DIMS)")
    plt.errorbar(dist2,
                 elem_ICF_KB.Ar,
                 yerr=elem_ICF_KB_error.Ar,
                 label="Ar_ICF (KB)")
    plt.errorbar(dist2,
                 elem_ICF_DIMS.Ar,
                 yerr=elem_ICF_DIMS_error.Ar,
                 label="Ar_ICF (DIMS)")
