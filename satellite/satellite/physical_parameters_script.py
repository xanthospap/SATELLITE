...
def analysiswithPyNeb(flux2D, flux2D_error, flux_angles, flux_angles_error,
                      ...
                      param_requered, param_mod_name, param_model_values, hdr):
    ...
    if param_requered[index] == "yes":
        Te_PA, Ne_PA = TeNeangles.TeNe(flux_angles, flux_angles_error, ang,
    ...
    if param_requered[index] == "yes":
        Te_2D, Ne_2D = TeNe2Ds.TeNe(flux2D, flux2D_error, line_names,
    ...
    if param_requered[index] == "yes":
        Te_slits, Ne_slits = TeNeslits.TeNe(flux_spec_slit,
                                            flux_spec_slit_error, line_names,
                                            lines_available, param_estimated,
                                            param_requered)
