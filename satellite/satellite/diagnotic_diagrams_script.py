...
def NIISIIplot(numerator1, denominator1, numerator2, denominator2, sizex,
    ...
    data_pos_ratio1 = pvs.positivevalues(data_ratio1, numerator1, denominator1,
                                         sizex, sizey, 0)
    ...
    data_pos_ratio2 = pvs.positivevalues(data_ratio2, numerator2, denominator2,
                                         sizex, sizey, 0)
