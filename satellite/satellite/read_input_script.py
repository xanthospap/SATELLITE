...
def read_input_images(line_name, irequested, param, flux_or_error):
    ...
    if flux_or_error == "fluxes":
        for linet in [
                l for l in zip(line_name, irequested) if l[0].endswith('s')
        ]:
            linem, requested = linet[0], linet[1]
            if linem == 'HI_6563s' and requested == 'yes':
                dataHa, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataHb, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataHg, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataHd, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataHeIa, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataHeIb, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataHeIIa, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataHeIIb, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataNIIa, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataNIIb, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataNIIc, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataNI, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataOIIIa, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataOIIIb, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataOIIIc, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataOIIa, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataOIIb, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataOIIc, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataOIId, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataOIa, hdr = getdata('image_data/' + linem + '.fit',
                                       0,
                                       header=True)
                ...
                dataOIb, hdr = getdata('image_data/' + linem + '.fit',
                                       0,
                                       header=True)
                ...
                dataOIc, hdr = getdata('image_data/' + linem + '.fit',
                                       0,
                                       header=True)
                ...
                dataSIIa, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataSIIb, hdr = getdata('image_data/' + linem + '.fit',
                                        0,
                                        header=True)
                ...
                dataSIIIa, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataSIIIb, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataClIIIa, hdr = getdata('image_data/' + linem + '.fit',
                                          0,
                                          header=True)
                ...
                dataClIIIb, hdr = getdata('image_data/' + linem + '.fit',
                                          0,
                                          header=True)
                ...
                dataArIII, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataArIVa, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataArIVb, hdr = getdata('image_data/' + linem + '.fit',
                                         0,
                                         header=True)
                ...
                dataCI, hdr = getdata('image_data/' + linem + '.fit',
                                      0,
                                      header=True)
                ...
                dataCII, hdr = getdata('image_data/' + linem + '.fit',
                                       0,
                                       header=True)
                ...
                dataNeIIIa, hdr = getdata('image_data/' + linem + '.fit',
                                          0,
                                          header=True)
                ...
                dataNeIIIb, hdr = getdata('image_data/' + linem + '.fit',
                                          0,
                                          header=True)
    ...
    if flux_or_error == "errors":
        for linet in [
                l for l in zip(line_name, irequested) if l[0].endswith('e')
        ]:
            linem, requested = linet[0], linet[1]
